...
import { Breadcrumb, BreadcrumbItem , Form, Label, FormGroup, Input, Button, Col, FormFeedback } from 'reactstrap';
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        <Form className="mt-1" onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                <Label htmlFor="" md={2}>Email</Label>
                                <Col md={10}>
                            ...
                            <FormGroup row>
                                <Col md={{size: 10, offset: 2}}>
                                    <Button type="submit" color="primary" className="button-radius">
                                        Send Feedback
                                    </Button>
                                </Col>
                            </FormGroup>
